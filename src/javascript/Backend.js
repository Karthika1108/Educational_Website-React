        ...
        <div>
            ...
            <div className="container" >
                <div className="item" > 
                 ...
                 <div className="cont">Course Name : Full HTML <br></br>Course Duration : 10hours<br></br>Mentor : Mr James  <br></br>&#x20B9;499 <span style={{fontWeight:100}}> &#x20B9;<del>3999</del></span><br></br>
                 <button className="b">Register </button></div>
                </div>
                <div className="item">
                <img className="img1" src={css}></img>
                 <div className="cont">Course Name : Basic CSS <br></br>Course Duration : 12hours<br></br>Mentor : Mr John  <br></br>&#x20B9;499 <span style={{fontWeight:100}}> &#x20B9;<del>3999</del></span> <br></br>
                 <button className="b">Register </button></div>
                
                </div>
                <div className="item" >
                <img className="img1" src={js}></img>
                 <div className="cont">Course Name :  JavaScript <br></br>Course Duration : 10hours<br></br>Mentor : Mr Malvik  <br></br>&#x20B9;499 <span style={{fontWeight:100}}> &#x20B9;<del>3999</del></span> <br></br>
                 <button className="b">Register </button></div>
